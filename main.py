...
class KBTest(unittest.TestCase):
    ...
    def runPlayXSteps(self, solver, plays, timeout=3600):
        """
    ...
    def runSolve(self, solver, timeout=3600):
        """
    ...
    def test15_DFS_8Puzzle(self):
        p8 = Puzzle8Game()
        p8.read('puzzle8_center_empty.txt')
        required = [
            'fact: (movable tile6 pos3 pos2 pos3 pos3)',
            'fact: (movable tile7 pos2 pos3 pos3 pos3)',
        ]
        p8.setWinningCondition(required, 'puzzle8_all_forbidden.txt')
        self.assertFalse(p8.isWon())

        solver = SolverDFS(p8,((1,2,3),(4,5,6),(8,7,-1)))
        self.runSolve(solver)

    def test16_BFS_8Puzzle(self):
        p8 = Puzzle8Game()
        p8.read('puzzle8_center_empty.txt')
        required = [
            'fact: (movable tile6 pos3 pos2 pos3 pos3)',
        ...
        solver = SolverBFS(p8,((1,2,3),(4,5,6),(8,7,-1)))
        self.runSolve(solver)

    def test17_DFS_8Puzzle(self):
        p8 = Puzzle8Game()
        p8.read('puzzle8_top_right_empty.txt')
        required = [
            'fact: (movable tile6 pos3 pos2 pos3 pos3)',
